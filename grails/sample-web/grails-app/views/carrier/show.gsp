...
<html>
    ...
    <body>
        ...
        <div id="show-carrier" class="content scaffold-show" role="main">
            ...
            <f:display bean="carrier" />
            <g:form resource="${this.carrier}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.carrier}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
