...
<html>
    ...
    <body>
        ...
        <div id="show-invoice" class="content scaffold-show" role="main">
            ...
            <g:form resource="${this.invoice}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.invoice}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
