...
import local.example.warehause.data.entity.ContactEntity;
import local.example.warehause.data.repository.ContactRepository;
...
public class ContactService {
    ...
    public void update(ContactEntity updatedContactEntity) {
        this.update(updatedContactEntity, updatedContactEntity.getId());
    }
