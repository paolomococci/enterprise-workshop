...
import local.example.warehause.data.entity.PositionEntity;
import local.example.warehause.data.repository.PositionRepository;
...
public class PositionService {
    ...
    public List<PositionEntity> readAll(PageRequest pageRequest) {
        return (List<PositionEntity>) positionRepository.findAll();
    }
