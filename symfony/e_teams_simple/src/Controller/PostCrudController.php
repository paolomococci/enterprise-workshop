...
{
    /**
     * @Route("/", name="post_crud_index", methods={"GET"})
     */
    ...
    /**
     * @Route("/new", name="post_crud_new", methods={"GET","POST"})
     */
    ...
    /**
     * @Route("/{id}", name="post_crud_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{id}/edit", name="post_crud_edit", methods={"GET","POST"})
     */
    ...
    /**
     * @Route("/{id}", name="post_crud_delete", methods={"POST"})
     */
