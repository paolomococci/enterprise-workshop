...
public class MainView
    ...
    private List<Tab> createHorizontalMenuItems() {
        final HorizontalMenuItemHelper[] horizontalMenuItems = new HorizontalMenuItemHelper[]{
                ...
                new HorizontalMenuItemHelper("Customer Detail", "", CustomerDetailView.class),
                new HorizontalMenuItemHelper("Invoice Detail", "", InvoiceDetailView.class),
                new HorizontalMenuItemHelper("Lot Detail", "", LotDetailView.class),
                new HorizontalMenuItemHelper("Machine Detail", "", MachineDetailView.class),
                new HorizontalMenuItemHelper("Operator Detail", "", OperatorDetailView.class),
                new HorizontalMenuItemHelper("Position Detail", "", PositionDetailView.class),
                new HorizontalMenuItemHelper("Product Detail", "", ProductDetailView.class),
                new HorizontalMenuItemHelper("Supplier Detail", "", SupplierDetailView.class)
        };
