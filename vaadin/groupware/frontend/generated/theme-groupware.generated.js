...
import stylesCss from 'themes/groupware/styles.css';
import '@vaadin/vaadin-lumo-styles/typography.js';
import '@vaadin/vaadin-lumo-styles/color.js';
import '@vaadin/vaadin-lumo-styles/spacing.js';
import '@vaadin/vaadin-lumo-styles/badge.js';
import '@vaadin/vaadin-lumo-styles/utility.js';
import vaadinButtonCss from 'themes/groupware/components/vaadin-button.css';
import vaadinPasswordFieldCss from 'themes/groupware/components/vaadin-password-field.css';
import vaadinTextAreaCss from 'themes/groupware/components/vaadin-text-area.css';
import vaadinTextFieldCss from 'themes/groupware/components/vaadin-text-field.css';

window.Vaadin = window.Vaadin || {};
window.Vaadin['_vaadintheme_groupware_globalCss'] = window.Vaadin['_vaadintheme_groupware_globalCss'] || [];
export const applyTheme = (target) => {
  
  const injectGlobal = (window.Vaadin['_vaadintheme_groupware_globalCss'].length === 0) || (!window.Vaadin['_vaadintheme_groupware_globalCss'].includes(target) && target !== document);
  if (injectGlobal) {
    injectGlobalCss(stylesCss.toString(), target);
    
    window.Vaadin['_vaadintheme_groupware_globalCss'].push(target);
  }
  if (!document['_vaadintheme_groupware_componentCss']) {
    registerStyles(
      'vaadin-button',
      css`
    ...
    document['_vaadintheme_groupware_componentCss'] = true;
  }
